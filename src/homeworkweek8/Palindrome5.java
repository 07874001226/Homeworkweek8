...
reverse.
If both are the same then the number is a palindrome otherwise it is not.Tip: Logic to reverse a number
...
//Main Methods
    public static void main(String[] args) {
        System.out.println(Palindrome5.ispalindrome(-1221));//Print Statement
